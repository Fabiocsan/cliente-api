...
public interface ClienteApi {
    ...
    @ApiOperation(value = "Consulta cliente existente por sobrenome.", nickname = "consultaPorSobrenome", notes = "Esta operação tem por objetivo consultar um cliente existente por sobrenome.", response = Clientes.class, tags={ "Consulta", })
    @ApiResponses(value = { 
